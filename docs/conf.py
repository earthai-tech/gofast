...
import gofast 
from gofast.tools._packaging_version import parse
from gofast._docstring import gf_rst_epilog
...
project = 'gofast'
copyright = f"2023-{time.strftime('%Y')}"
author = 'K. Laurent Kouadio'
# The full version, including alpha/beta/rc tags
try : version = release = gofast._version.version
except : version = release = gofast.__version__
...
issues_github_path = 'WEgeophysics/gofast'
...
html_logo = "_static/gofast_logo.svg"
html_favicon = "_static/gofast_logo.ico"

# Define the json_url for our version switcher.
json_url = "https://gofast.readthedocs.io/en/latest/_static/switcher.json"
...
html_theme_options = {
    "icon_links": [
        ...
        {
            "name": "StackOverflow",
            "url": "https://stackoverflow.com/tags/gofast",
        ...
        },
        {
            ...
            {
                "name": "PyPI",
                "url": "https://pypi.org/project/gofast", 
...
# latex_documents = [
#       (master_doc, 'gofast.tex', u'Machine learning in gofast exploration',
#       u'L. Kouadio', 'manual'),
# ]
latex_documents = [
    (
...
# the title page.
# latex_logo = "_static/gofast_latex_logo.png"
...
man_pages = [
    (master_doc, 'gofast', u'gofast Documentation',
      [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gofast', u'gofast Documentation',
      author, 'gofast', 'Machine learning in water exploration',
      'Miscellaneous'),
]
...
def make_wx_apidoc(_):
    """ Generate gofast API doc and create a subsequent list of  modules. 
    Refer to https://github.com/sphinx-contrib/apidoc
    """
    # get the current directory 
    c_dir = os.path.dirname(__file__)
    # specify the module directory 
    m_dir = os.path.join(c_dir, '../gofast')
