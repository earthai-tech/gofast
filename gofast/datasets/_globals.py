...
DYSPNEA_LABELS_DESCR={
    'gender': {0: 'Female', 1: 'Male'},
     'dyspnea': {0: 'Acute', 1: 'Chronic'},
     'nyha_intensity': {2: 'IV', 1: 'III', 0: 'II'},
     'frequency': {1: 'Polypnea', 0: 'Bradypnea'},
     'cough': {1: 'Yes', 0: 'No'},
     'fever': {0: 'No', 1: 'Yes'},
     'asthenia': {0: 'No', 1: 'Yes'},
     'admission_method': {4: 'Taxi',
                          0: 'Ambulance',
                          2: 'Personal vehicle',
                          1: 'Firefighter',
                          3: 'SAMU',
     ...
     'establishment_of_origin': {
                        ...
                        5: 'FSU',
                        15: 'Yopougon'},
     'toxic_tobacco': {0: 'No', 1: 'Yes'},
     'toxic_alcohol': {0: 'No', 1: 'Yes'},
     'condition': {1: 'Bad', 0: 'AVERAGE', 2: 'Good'},
     'state_of_the_pupils': {0: 'Normal', 1: 'Unnatural'},
     'conjunctivas': {1: 'colorful', 0: 'blades', 2: 'not very colorful'},
     'imo': {1: 'Yes', 0: 'No'},
     'condition_of_the_mucous_membranes': {0: 'Dry', 1: 'Wet'},
     'dehydration_skin_fold': {1: 'Yes', 0: 'No'},
     'respiratory_distress': {1: 'Yes', 0: 'No'},
     'heart_sound': {0: 'Normal', 1: 'Unnatural'},
     'breath': {0: 'No', 1: 'Yes'},
     'heart_failure': {0: 'No', 1: 'Yes'},
     'lymphadenopathy': {0: 'No', 1: 'Yes'},
     'diagnosis_retained': {17: 'Pneumonitis',
                      13: 'Other',
                      16: 'Pneumonia Other',
                      3: 'Covid 19',
                      11: 'Heart failure',
     ...
     'outcome_of_hospitalization': {
                      1: 'Return home',
                      0: 'Deceased',
                      2: 'Transfer to another care unit',
