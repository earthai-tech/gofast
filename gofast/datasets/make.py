...
def make_financial_market_trends(
    ...
    **Relative Strength Index (RSI)**: A momentum indicator measuring price
    ...
    Examples
    --------
    >>> from gofast.datasets.make import make_financial_market_trends
    ...
    # Fetch dataset descriptions if available
...
def make_system_dynamics(
    *, samples=1000, 
    ...
    Examples
    --------
    >>> from gofast.datasets.make import make_control_system_dynamics
