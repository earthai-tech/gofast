...
from .utils import make_coords, get_bearing 
...
class Profile: 
    ...
    def distance (self, *, average_distance: bool = True): 
        ...
        See Also 
        ---------
        gofast.tools.exmath.get_distance: 
        ...
        --------- 
        >>> import numpy as np 
        >>> from gofast.site import Profile 
    ...
    def scale_positions (self, **sp_kws): 
        ...
        -----------
        sp_kws: dict 
           Keyword arguments passed to :func:`~gofast.tools.scalePosition`. 
        ...
        See also 
        ---------
        gofast.tools.scalePositions: 
            Scale positions using the `scipy` curve fit. 
        gofast.tools.exmath.scale_positions: 
        ...
        *, 
        ...
        if self.coordinate_system !='utm': 
            ...
            warnings.warn((
                ...
                " positions data to UTM (ref:`gofast.site.to_utm_in`) before"
    ...
    def f_ (ar , /,  func: str | _F  = 'dms->ll'): 
        ...
        func: Callable or str, default ='dms->ll'
            ...
            - :func:`~gofast.tools.gisutils.convert_position_str2float` 
              for ``:dd:mm:ss``  to foat(long, lat) coordinates. If 
              string is passed it should be ['dms2ll'|'dmstoll'|'dms-<ll']. 
            - :func:`~gofast.tools.gisutils.convert_position_float2str` 
    ...
    def make_xy_coordinates (
        ...
        **kws 
        ...
        kws: dict, 
           Additional keywords of :func:`~gofast.tools.exmath.makeCoords`.   
        ...
        See Also 
        --------
        gofast.tools.coreutils.makeCoords: 
        ...
        >>> data = gf.make_erp (n_stations =2 ).frame 
    ...
    def interpolate(
        ...
        **kws
        ...
        kws: dict,
           ...
           :func:`~gofast.tools.funcutils.interpolate_grid`. 
           
        Returns
        --------
        self|x, y, elev: :class:`~gofast.site.Profile` or Arraylikes 
           `:class:`.Profile` objects if `inplace` is ``True`` or 
           interpolated x, y and elev. 
           
        See Also 
        --------
        gofast.tools.funcutils.interpolate_grid: 
    ...
    def out (
        ...
        >>> import numpy as np 
        >>> import gofast as gf 
        >>> data = gf.make_erp (n_stations=24).frame 
        >>> gf.site.Profile.out (data.easting, data.northing, verbose =True  )
        >>> elev = np.random.permutation  (len(data.easting)) *100 
        >>> gf.site.Profile.out (data.easting, data.northing, elev, 
    ...
    def plot (
        ...
        **kws): 
        ...
        kws: dict, 
           ...
           :func:`~gofast.plot.plotutils.plot_text`
           
        .. versionadded:: 0.2.1 
        
        
        """
        from ..plot.utils import plot_text 
...
Examples 
--------- 
>>> from gofast.datasets import load_edis
>>> from gofast.site import Profile  
...
class Location (object): 
    ...
    def __init__(
        ...
        **kwds
        ...
        self._logging = gofastlog.get_gofast_logger(
    ...
    def to_utm_in(
        ...
        **kws 
        ...
        kws: dict, 
           Keywords argument passed to :meth:`~gofast.site.Location.to_utm`. 
    ...
    def to_latlon_in(
        ...
        **kws 
        ...
        kws: dict, 
           Keywords argument passed to :meth:`~gofast.site.Location.to_latlon`. 
        ...
        See Also
        ------------
        gofast.site.Location.to_latlon: 
